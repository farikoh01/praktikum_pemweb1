...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-12">
          <form class="form-horizontal p-5 shadow h-100" style="background-color: rgb(105, 105, 105)" method="GET" action="databmi.php">
            ...
            <!------------>
              <div class="text-center">
                <input class="btn btn-light" type="submit" value="Simpan" name="proses"/>
              </div>
          </form>
        </div> <!--col--->
